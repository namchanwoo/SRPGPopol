...
int32 USRGFunctionLibrary::GetExp(int32 Level, float ExpExponent)
{
	SRPG_LOG_FUNCTION;
...
int32 USRGFunctionLibrary::GetHeroStat(int32 Level, int32 MaxLevel, int32 InitialStat, int32 FirstLevelStat,
									   int32 LastLevelStat)
{
	SRPG_LOG_FUNCTION;
...
FHeroStats USRGFunctionLibrary::CalculateHeroStats(int32 Level, int32 MaxLevel, FHeroStats InitialStats,
...
int32 USRGFunctionLibrary::GetHeroLevel(int32 Exp, float ExpExponent, int32 MaxLevel)
{
	SRPG_LOG_FUNCTION;
...
void USRGFunctionLibrary::GetHeroStats(AExploreHeroBase* ExploreHero, int32& OutLevel,
...
FHeroStats USRGFunctionLibrary::GetEquipmentStats(UObject* WorldContextObject,
