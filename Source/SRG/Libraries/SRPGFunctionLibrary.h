...
#include "SRPGFunctionLibrary.generated.h"
 ...
 */
UCLASS()
class SRG_API USRPGFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category="SRG Function Library", meta=(WorldContext="WorldContextObject"))
	static void GetElementColorAndImage(UObject* WorldContextObject,EElement InElement, FLinearColor& ElementColor, UTexture2D*& ElementImage,
								 UTexture2D*& ElementResistImage);
