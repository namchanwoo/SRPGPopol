...
USRPGGameInstance::USRPGGameInstance(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
}

void USRPGGameInstance::OnNewGameStarted()
{
...
bool USRPGGameInstance::GetShouldLoadGame()
{
	return bShouldLoadGame;
}

void USRPGGameInstance::LoadGame()
{
	// 저장된 게임이 유효한지 확인
...
void USRPGGameInstance::LoadThisGame(URPGSaveGame* InRPGSaveGame)
{
...
void USRPGGameInstance::SaveGame(FString InSlotName)
{
	SlotName = InSlotName;
...
void USRPGGameInstance::LoadInteractables()
{
...
void USRPGGameInstance::LoadHero()
{
...
void USRPGGameInstance::LoadQuest(AQuestBase* Quest)
{
...
void USRPGGameInstance::LoadQuests()
{
...
void USRPGGameInstance::LoadShops()
{
...
void USRPGGameInstance::LoadHeroTransform()
{
...
void USRPGGameInstance::SaveExploreHero()
{
	EnsureSaveGameInitialized();
...
void USRPGGameInstance::SaveBattleHero(ABattleHeroBase* InBattleHero)
{
	EnsureSaveGameInitialized();
...
TArray<FPlayerCharacterData> USRPGGameInstance::GetSurvivingPlayerCharacters(ABattleHeroBase* InBattleHero)
{
...
void USRPGGameInstance::AddQuest(AQuestBase* InQuest)
{
...
void USRPGGameInstance::RemoveQuest(AQuestBase* InQuest)
{
	// 퀘스트의 고유 식별자 생성
	const FString CurrentQuestName = GenerateUniqueIdentifier(InQuest);
...
void USRPGGameInstance::UpdateBattleQuest(const TArray<AQuestBase*>& AllQuests)
{
...
void USRPGGameInstance::SaveBattleQuest(ABattleQuestBase* InBattleQuest)
{
...
void USRPGGameInstance::AddInteractions(AInteractionDetector* InteractableBase)
{
	EnsureSaveGameInitialized();
...
void USRPGGameInstance::AddRecruitShop(AShopBase* InShop, FShopRecruitmentList InValue)
{
	EnsureSaveGameInitialized();
...
void USRPGGameInstance::AddEquipmentShop(AShopBase* InShop, FShopEquipmentList InEquipment)
{
	EnsureSaveGameInitialized();
...
void USRPGGameInstance::ChangeMap(FName InMapName)
{
	SaveExploreHero();
...
void USRPGGameInstance::ChangeMapForBattle(const TArray<FEnemyCharacterData>& InEnemyList,
...
void USRPGGameInstance::ChangeMapAfterBattle(ABattleHeroBase* InBattleHero, int32 InExpReward)
{
...
void USRPGGameInstance::EnsureSaveGameInitialized()
{
	if (!IsValid(RpgSaveGame))
	{
		OnNewGameStarted();
...
FString USRPGGameInstance::GenerateUniqueIdentifier(AActor* Actor)
{
	FString CurrentLevelName = UGameplayStatics::GetCurrentLevelName(this);
...
FPlayerCharacterData USRPGGameInstance::GeneratePlayerCharacterData(ACharacterBase* PlayerCharacter)
{
