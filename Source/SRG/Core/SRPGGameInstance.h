...
/**
 * 게임 상태, 맵 간 전환, SRG 프로젝트의 퀘스트, 상점 및 영웅 변형과 같은 요소를 관리합니다.
 */
UCLASS()
class SRG_API USRPGGameInstance : public UGameInstance
{
	GENERATED_BODY()

public:
	USRPGGameInstance(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	/*---	      	    Setting    	      	---*/
public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* Element_Normal;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* Element_Fire;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* Element_Earth;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* Element_Air;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* Element_Water;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* ElementResist_Normal;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* ElementResist_Fire;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* ElementResist_Earth;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* ElementResist_Air;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="SRG Game Instance|Setting")
	UTexture2D* ElementResist_Water;
};
